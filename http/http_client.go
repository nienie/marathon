...
func (c *LoadBalancerHTTPClient) Do(ctx context.Context, req *http.Request, requestConfig config.ClientConfig) (*http.Response, error) {
	...
	resp, err := c.BaseLoadBalancerClient.ExecuteWithLoadBalancer(request, nil)
	if err != nil || resp == nil {
...
func (c *LoadBalancerHTTPClient) Execute(request client.Request, requestConfig config.ClientConfig) (client.Response, error) {
	...
	return c.ExecuteHTTP(req, requestConfig)
}
